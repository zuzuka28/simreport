...
import (
	...
	server2 "shingleindex/api/nats/event"
	"shingleindex/api/nats/event/handler/indexer"
	shingleindex3 "shingleindex/api/nats/micro/handler/shingleindex"
	"shingleindex/api/nats/micro/server"
	"shingleindex/internal/config"
	"shingleindex/internal/repository/document"
	"shingleindex/internal/repository/shingleindex"
	document2 "shingleindex/internal/service/document"
	shingleindex2 "shingleindex/internal/service/shingleindex"
)
